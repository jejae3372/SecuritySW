...
/*
     0  4  8 12                     0  4  8 12
     1  5  9 13                     5  9 13  1
     2  6 10 14  --[ShiftRows]-->  10 14  2  6
     3  7 11 15                    15  3  7 11
     [ 0  5 10 15] = st[0][0] st[1][1] st[2][2] st[3][3]
     [ 4  9 14  3] = st[1][0] st[2][1] st[3][2] st[0][3]
     [ 8 13  2  7] = st[2][0] st[3][1] st[0][2] st[1][3]
     [12  1  6 11] = st[3][0] st[0][1] st[1][2] st[2][3]
*/
// [5] = st[1][1] = (st[1] >> 16) & 0xff
// [10] = st[2][2] = (st[2] >> 8) & 0xff
...
/* 시험시험시험
     ...
     0  4  8 12                        0  4  8 12
     1  5  9 13                       13  1  5  9
     2  6 10 14  --[InvShiftRows]-->  10 14  2  6
     3  7 11 15                        7 11 15  3
     [ 0 13 10  7] = st[0][0] st[3][1] st[2][2] st[1][3]
     [ 4  1 14 11] = st[1][0] st[0][1] st[3][2] st[2][3]
     [ 8  5  2 15] = st[2][0] st[1][1] st[0][2] st[3][3]
     [12  9  6  3] = st[3][0] st[2][1] st[1][2] st[0][3]
*/
void AES32_EqInv_round(u32 state[4], u32 rk[4]) {
    ...
    tmp[1] = Td0[state[1] >> 24] ^ Td1[(state[0] >> 16) & 0xff] ^ Td2[(state[3] >> 8) & 0xff] ^ Td3[state[2] & 0xff] ^ rk[0];
	tmp[2] = Td0[state[2] >> 24] ^ Td1[(state[1] >> 16) & 0xff] ^ Td2[(state[0] >> 8) & 0xff] ^ Td3[state[3] & 0xff] ^ rk[0];
	tmp[3] = Td0[state[3] >> 24] ^ Td1[(state[2] >> 16) & 0xff] ^ Td2[(state[1] >> 8) & 0xff] ^ Td3[state[0] & 0xff] ^ rk[0];
